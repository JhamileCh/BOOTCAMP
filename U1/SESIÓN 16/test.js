...
var opciones = [
    ...
    function actualizarPuntaje(alternativa){
        ...
        actualizado = puntajePorOpción[i][alternativa]+actualizado //actualización de puntaje
        i++;
    ...
    document.getElementById("op1").addEventListener("click",function(){actualizarPuntaje(0)}) //cada que el usuario haga click, activa
